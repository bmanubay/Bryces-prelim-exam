...
% ABSTRACT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\huge \textbf{A method for redesigning molecular dynamics force field parameterization by use of a Bayesian statistical framework}}
\indent Bryce C. Manubay
\indent \textit{University of Colorado - Department of Chemical and Biological Engineering}
\indent (Dated: \today) 
