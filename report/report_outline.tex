...
\centering
\includegraphics[width=0.35\textwidth]{ThermoML_workflow}
\caption{\label{fig:thermoml}A simplified diagram of the filtering algorithm used to find experimental data for use as evidence.}
\end{wrapfigure}
